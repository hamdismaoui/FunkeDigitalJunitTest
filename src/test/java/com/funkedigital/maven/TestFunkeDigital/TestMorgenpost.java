...
public class TestMorgenpost {

	private String url;
	private Boolean expected;

	public TestMorgenpost(String url, Boolean expected) {
		super();
	...
	public static Collection<Object[]> data() throws IOException {
		...
		ArrayList<String> urlList = grabber.getFrom("https://www.morgenpost.de/sitemaps/news.xml");
